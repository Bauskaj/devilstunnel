...
echo -e "\033[36m# // Author: Unders Tunnel\e[0m"
echo -e "\033[36m# // Description: Xray Multiport\e[0m"
echo -e "\033[36m# // Whatsapp : wa.me/+6287724404514\e[0m"
echo -e "\033[36m# //====================================\e[0m"
sleep 1
Green="\e[92;1m"
RED="\033[31m"
...
logofigh() {
    ...
    echo -e " ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───"
    echo -e " ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───"
    echo -e "    │    ${YELLOW}Copyright${FONT} (C)${GRAY}https://t.me/Undersx$NC     │"
    echo -e "    └───────────────────────────────────────────────┘"
...
wget -q -O /root/cf.sh "https://raw.githubusercontent.com/Bauskaj/panel/main/ssh/slhost.sh"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Bauskaj/panel/main/SLDNS/install-sldns && chmod +x install-sldns && ./install-sldns
clear
apete_apdet() {
    apt update -y
    apt install sudo -y
...
ins_menu() {
clear
    wget https://raw.githubusercontent.com/Bauskaj/panel/main/JB7/menu.zip
    unzip menu.zip
    chmod +x menu/*
...
ins_janda() {
wget https://raw.githubusercontent.com/Bauskaj/panel/main/JB7/tm.sh &&  chmod +x tm.sh && ./tm.sh
}
...
restart_system() {
    USRSC=$(curl https://raw.githubusercontent.com/Bauskaj/regis/main/Ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/Bauskaj/regis/main/Ip | grep $ipsaya | awk '{print $3}')
